...
- Mention what the character is wearing or stuff more than the character's appearance
...
- Ensure visual style matches throughout with the image style that is given

5. IMAGE PROMPT CREATION
- Be precise when talking about imaginary or real objects
Example: When the segment is explaining sound waves, say sound waves and describe them as white curl lines instead of simply mentioning waves
- If the video segment is explaining something and the image before showed a character using the object or a more general view, in this video you can focus on the object
Example: If the previous video prompt talked about a man drinking the water and the story is explaining the water bottle, in this image, show a magnified view of the water bottle
- Think creativly and don't be the same as the image before
- Give the audience a new view everytime


Constraints:
- Make the story logical and visually appealing for the audience
